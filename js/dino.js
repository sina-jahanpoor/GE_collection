...
const winLoseLine1 = document.getElementById("position-1");
const winLoseLine2 = document.getElementById("position-2");
...
function countScore() {
  scoreInterval = setInterval(() => {
    setScore(score + 1);
    if (score % 100 == 0) {
      winLoseLine1.classList.add("green-line");
      winLoseLine2.classList.add("green-line");
      setTimeout(()=>{
...
function stopGame() {
  ...
  winLoseLine1.classList.add("red-line");
  winLoseLine2.classList.add("red-line");
  setTimeout(()=>{
  winLoseLine1.classList.remove("red-line");
  winLoseLine2.classList.remove("red-line");
  },1500)
}
